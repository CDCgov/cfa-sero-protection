...
The purpose of this repo is to develop statistical tools to extract the following mathematical objects from serological data, for a generic pathogen:
1) The antibody titer distribution in a population
2) Protection level as a function of antibody titer
3) The protection distribution in a population

## Getting started

Currently, all statistical tools are under development. Guidance for getting started will be added as a pipeline begins to take shape.

## Project admins

- Ed Schrom <tec0@cdc.gov> (CDC/IOD/ORR/CFA)
